...
Interactive quiz game built with vanilla HTML, CSS & JavaScript.
...
- DOM manipulation with `getElementById` and `createElement`
...
- CSS Grid for answer button layout
- Screen-based navigation using CSS classes
